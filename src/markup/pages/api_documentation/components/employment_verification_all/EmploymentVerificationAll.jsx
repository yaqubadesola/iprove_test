...
import './employment_verification_all.css';
...
import { 
	...
	codeString, error404, 
	// requestBody, 
	codeString_header,curlRequest
 } from './jsondata';
import { Container } from 'react-bootstrap';
SyntaxHighlighter.registerLanguage('jsx', jsx);

const EmploymentVerificationAll = () => {
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>GET ALL EMPLOYMENT HISTORY VERIFICATIONS</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5 style={{padding:"5px",margin:"5px"}}>Get All Employment History Verifications</h5>
												<p>This endpoint allows you to get all employment history verifications.</p>

												<Accordion.Header>
												<input type="button" value="GET" size="sm" className="myButton" variant="primary"></input>
												&nbsp;&nbsp;&nbsp;&nbsp; <strong><small>{`https://testapi.iprove.ng/identity/api/v1/employment/get_verifications?page=0`}</small></strong>
												...
												<Container>
													...
													<br/>
													{/* <Row>
														<Col sm><p className="paramsHeading">Path</p></Col>
													</Row>
																...
																<Accordion.Header>
																	<Row>
																		<Col sm><p className="paramsb"><span className="circle"><Circle center={[15, 25]} radius={3} color='green' /></span>
																				&nbsp;&nbsp;200 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="paramsHeading">Successfully fetched Employment verifications</span></p>
																		</Col>
																	</Row>
...
export default EmploymentVerificationAll;