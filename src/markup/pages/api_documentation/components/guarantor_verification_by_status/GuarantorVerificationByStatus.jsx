...
import './guarantor_verification_by_status.css';
...
import { columns1, 
	...
	columns4, 
	columns5,
	//columns6, columns7,columns8,
	codeString, error404, 
	requestBody, codeString_header,curlRequest
 } from './jsondata';
import { Container } from 'react-bootstrap';
SyntaxHighlighter.registerLanguage('jsx', jsx);

const PropertyVerificationByStatus = () => {
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>FETCH AN GUARANTOR BY IDENTITY</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5 style={{padding:"5px",margin:"5px"}}>Fetch a verified guarantor for an Identity</h5>
												<p>This endpoint returns a verified guarantor for a given identity within a specified period.</p>
												<Accordion.Header>
												<input type="button" value="GET" size="sm" className="myButton" variant="primary"></input>
												&nbsp;&nbsp;&nbsp;&nbsp; <strong><small>{`https://testapi.iprove.ng/identity/api/v1/guarantor/get_verification_by_status/valid?page=0`}</small></strong>
												...
												<Container>
													...
													<br/> */}
													<Row>
														<Col sm><p className="paramsHeading">Available status</p></Col>
													</Row>
																...
																<Accordion.Header>
																	<Row>
																		<Col sm><p className="paramsb"><span className="circle"><Circle center={[15, 25]} radius={3} color='green' /></span>
																				&nbsp;&nbsp;200 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="paramsHeading">Successfully fetched Guarantor verifications</span></p>
																		</Col>
																	</Row>
																...
																<Accordion.Header>
																	<Row>
																		<Col sm><p className="paramsb"><span className="circle"><Circle center={[15, 25]} radius={3} color='red' /></span>
																				&nbsp;&nbsp;404 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="paramsHeading">Internal Server Error</span></p>
																		</Col>
																	</Row>
...
export default PropertyVerificationByStatus;