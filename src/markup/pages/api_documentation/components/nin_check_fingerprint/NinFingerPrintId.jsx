							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>CHECK NIN BY FINGERPRINT</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5>Check User Details by Fingerprint</h5>
												<Accordion.Header>
												<input type="button" value="GET" size="sm" className="myButton" variant="primary"></input>
												&nbsp;&nbsp;&nbsp;&nbsp; <strong><small>{`https://testapi.iprove.ng/identity/api/v1/nin/details/get_by_id/{fingerPrint}`}</small></strong>
												</Accordion.Header>
												<Accordion.Body>
												<Container>
													<Row>
...
export default NinFingerPrintId;