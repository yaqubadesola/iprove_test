...
import './address_verification.css';
...
import {  columns2, columns4, 
	columns5,columns6,columns7,columns8,columns9,
	columns10,columns11,
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>SUBMIT ADDRESS VERIFICATION</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<div className="mb-30 quoteTag">
											...
											<p className="mb-0">
											Please note that you are required to have a webhook set for address 
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5 style={{padding:"5px",margin:"5px"}}>Submit Address for Verification</h5>
												<p>This endpoint allows you to create address verifications</p>
												<Accordion.Header>
												<input type="button" value="POST" size="sm" className="myButton" variant="primary"></input>
												&nbsp;&nbsp;&nbsp;&nbsp; <strong><small>{`https://testapi.iprove.ng/identity/api/v1/address/request_verification`}</small></strong>
												</Accordion.Header>
												<Accordion.Body>
												<Container>
													<Row>
																...
																<Accordion.Header>
																	<Row>
																		<Col sm><p className="paramsb"><span className="circle"><Circle center={[15, 25]} radius={3} color='green' /></span>
																				&nbsp;&nbsp;200 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="paramsHeading">Address verification created.</span></p>
																		</Col>
																	</Row>
