...
import './guarantor_verification_cancel.css';
...
const AddressVerificationCancel = () => {
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>CANCEL GUARANTOR VERIFICATION</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5 style={{padding:"5px",margin:"5px"}}>Get Cancel Property Verification</h5>
												<p>This endpoint allows you cancel a guarantor verification.</p>
												<Accordion.Header>
																...
																<Accordion.Header>
																	<Row>
																		<Col sm><p className="paramsb"><span className="circle"><Circle center={[15, 25]} radius={3} color='green' /></span>
																				&nbsp;&nbsp;200 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="paramsHeading">Guarantor canceled Successful</span></p>
																		</Col>
																	</Row>
...
export default AddressVerificationCancel;