...
import './property_verification_submit.css';
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>SUBMIT PROPERTY VERIFICATION</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<div className="mb-30 quoteTag">
											...
											<p className="mb-0">
											Please note that you are required to have a webhook set for property 
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5 style={{padding:"5px",margin:"5px"}}>Submit Property for Verification</h5>
												<p>This endpoint allows you to create a property verification request</p>
												<Accordion.Header>
												<input type="button" value="POST" size="sm" className="myButton" variant="primary"></input>
												&nbsp;&nbsp;&nbsp;&nbsp; <strong><small>{`https://testapi.iprove.ng/identity/api/v1/property/request_verification`}</small></strong>
												</Accordion.Header>
												<Accordion.Body>
												<Container>
													{/* <Row>
																...
																<Accordion.Header>
																	<Row>
																		<Col sm><p className="paramsb"><span className="circle"><Circle center={[15, 25]} radius={3} color='green' /></span>
																				&nbsp;&nbsp;200 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="paramsHeading">Property verification Submitted Successful.</span></p>
																		</Col>
																	</Row>
