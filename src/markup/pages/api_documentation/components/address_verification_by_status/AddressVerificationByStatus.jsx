...
import './address_verification_by_status.css';
...
const AddressVerificationByStatus = () => {
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>FETCH AN ADDRESS BY IDENTITY</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												...
												&nbsp;&nbsp;&nbsp;&nbsp; <strong><small>{`https://testapi.iprove.ng/identity/api/v1/address/get_verification_by_status/pending?page=0`}</small></strong>
...
export default AddressVerificationByStatus;