...
import './guarantor_verification_submit.css';
...
const PropertyVerificationSubmit = () => {
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>SUBMIT GUARANTOR VERIFICATIONS</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<div className="mb-30 quoteTag">
											...
											<p className="mb-0">
											Please note that you are required to have a webhook set for guarantor 
											verification requests to be successful. If they are not set, 
											you will not get notified when the verification has been completed.
											</p>
										</div>
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5 style={{padding:"5px",margin:"5px"}}>Submit Guarantor for Verifications</h5>
												<p>This endpoint allows you to create a guarantor verifications request</p>
												<Accordion.Header>
												<input type="button" value="POST" size="sm" className="myButton" variant="primary"></input>
												&nbsp;&nbsp;&nbsp;&nbsp; <strong><small>{`https://testapi.iprove.ng/identity/api/v1/guarantor/request_verification`}</small></strong>
												</Accordion.Header>
												<Accordion.Body>
												<Container>
													<Row>
													...
													<Row>
														...
														<Row>
															<Col sm><p>{columns12[0].title}</p></Col>
																...
																<Accordion.Header>
																	<Row>
																		<Col sm><p className="paramsb"><span className="circle"><Circle center={[15, 25]} radius={3} color='green' /></span>
																				&nbsp;&nbsp;200 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="paramsHeading">Guarantor verification Submitted Successful.</span></p>
																		</Col>
																	</Row>
...
export default PropertyVerificationSubmit;