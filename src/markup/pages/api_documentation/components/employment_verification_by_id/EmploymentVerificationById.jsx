...
import './emloyment_verification_by_id.css';
...
const EmploymentVerificationById = () => {
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>GET EMPLOYMENT HISTORY VERIFICATION BY ID</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5 style={{padding:"5px",margin:"5px"}}>Get Employment History Verification By ID </h5>
												<p>This endpoint allows you to fetch specific employment verifications.</p>
												<Accordion.Header>
												<input type="button" value="GET" size="sm" className="myButton" variant="primary"></input>
												&nbsp;&nbsp;&nbsp;&nbsp; <strong><small>{`https://testapi.iprove.ng/identity/api/v1/employment/get_verification/{verificationId}`}</small></strong>
...
export default EmploymentVerificationById;