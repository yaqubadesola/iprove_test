...
import './verify_user_detail_phone_no.css';
...
const VerifyUserDetailByPhoneNo = () => {
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>VERIFY  USER DETAILS BY PHONE NO</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5 style={{padding:"5px",margin:"5px"}}>Verify  User Details by Phone No</h5>
												<p>This endpoint allows you get User Dtails by Phone No</p>
...
export default VerifyUserDetailByPhoneNo;