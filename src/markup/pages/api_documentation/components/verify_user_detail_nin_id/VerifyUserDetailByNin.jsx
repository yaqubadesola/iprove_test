...
import './verify_user_detail_nin_id.css';
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>VERIFY  USER DETAILS BY NIN ID</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5 style={{padding:"5px",margin:"5px"}}>Verify  User Details by NIN ID</h5>
												<p>This endpoint allows you get User Dtails by NIN ID</p>

												<Accordion.Header>
												<input type="button" value="GET" size="sm" className="myButton" variant="primary"></input>
												&nbsp;&nbsp;&nbsp;&nbsp; <strong><small>{`https://testapi.iprove.ng/identity/api/v1/nin/details/get_by_id/{NIN}`}</small></strong>
																...
																<Accordion.Header>
																	<Row>
																		<Col sm><p className="paramsb"><span className="circle"><Circle center={[15, 25]} radius={3} color='green' /></span>
																				&nbsp;&nbsp;200 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="paramsHeading">Request Successfully</span></p>
																		</Col>
																	</Row>
...
export default VerifyUserDetailByNin;