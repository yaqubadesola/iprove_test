...
import {  columns2,columns3,columns4, 
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>SUBMIT BUSINESS VERIFICATION</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<div className="mb-30 quoteTag">
											...
											<p className="mb-0">
											Please note that you are required to have a webhook set for business verification requests to be successful. 
											If they are not set, you will not get notified when the verification has been completed.
											</p>
										</div>
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5 style={{padding:"5px",margin:"5px"}}>Submit Business Address for Verification</h5>
												<Accordion.Header>
												<input type="button" value="POST" size="sm" className="myButton" variant="primary"></input>
												&nbsp;&nbsp;&nbsp;&nbsp; <strong><small>{`https://testapi.iprove.ng/identity/api/v1/business/request_verification`}</small></strong>
												</Accordion.Header>
												<Accordion.Body>
												<Container>
													<Row>
