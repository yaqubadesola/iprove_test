...
import './property_verification_by_status.css';
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>FETCH AN PROPERTY BY IDENTITY</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5 style={{padding:"5px",margin:"5px"}}>Fetch a verified property for an Identity</h5>
												<p>This endpoint returns a verified property for a given identity within a specified period.</p>
												<Accordion.Header>
												<input type="button" value="GET" size="sm" className="myButton" variant="primary"></input>
												&nbsp;&nbsp;&nbsp;&nbsp; <strong><small>{`https://testapi.iprove.ng/identity/api/v1/property/get_verification_by_status/valid?page=0`}</small></strong>
