...
import './employment_verification_by_status.css';
...
const EmploymentVerificationByStatus = () => {
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>FETCH AN EMPLOYMENT HISTORY BY IDENTITY</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5 style={{padding:"5px",margin:"5px"}}>Fetch a verified employment history by Identity</h5>
												<p>This endpoint returns a verified employment for a given identity within a specified period.</p>
												<Accordion.Header>
...
export default EmploymentVerificationByStatus;